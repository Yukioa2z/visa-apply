...
- **Fee:** For applications accepted on or after July 1, 2026, MOFA states approximate standard fees of JPY 15,000 for single-entry and JPY 30,000 for multiple-entry visas, converted into the issuing post's local currency. Nationality, purpose, bilateral waivers, and agency handling can change the payable amount, so confirm the responsible mission or portal before payment.
...
- **Fee:** For applications accepted on or after July 1, 2026, MOFA's amended fee order gives approximate standard amounts of JPY 15,000 for single-entry and JPY 30,000 for multiple-entry visas, normally collected in the issuing post's local currency. Nationality, purpose, reciprocal arrangements, and agency handling can change or waive the amount; verify the responsible mission's current tariff.
